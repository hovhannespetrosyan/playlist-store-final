...
describe('Writer', function () {
    ...
    describe('writeUInt', function () {
        ...
        it('when asked to write an integer outside of safe JavaScript range, should throw', function () {
            var writer = new writer_1.default();
            assert.throws(function () { return writer.writeUInt(MAX_SAFE_INTEGER + 1, 1); }, 'UInt is larger than safe JavaScript range');
        });
    ...
    describe('writeInt', function () {
        ...
        it('when asked to write an integer above safe JavaScript range, should throw', function () {
            var writer = new writer_1.default();
            assert.throws(function () { return writer.writeInt(MAX_SAFE_INTEGER + 1, 1); }, 'Int is larger than safe JavaScript range');
        });
        it('when asked to write an integer above safe JavaScript range, should throw', function () {
            var writer = new writer_1.default();
            assert.throws(function () { return writer.writeInt(MIN_SAFE_INTEGER - 1, 1); }, 'Int is smaller than safe JavaScript range');
        });
        it('when asked to write a non-integer, should throw', function () {
            var writer = new writer_1.default();
    ...
    describe('writeVarUInt', function () {
        ...
        it('when trying to write an unsafe integer, should throw', function () {
            var writer = new writer_1.default();
            assert.throws(function () { return writer.writeVarUInt(MAX_SAFE_INTEGER + 1); }, 'UInt is larger than safe JavaScript range');
        });
    ...
    describe('writeVarInt', function () {
        ...
        it('when trying to write an unsafe integer, should throw', function () {
            var writer = new writer_1.default();
            assert.throws(function () { return writer.writeVarInt(MAX_SAFE_INTEGER + 1); }, 'Int is larger than safe JavaScript range');
        });
        it('when trying to write an unsafe negative integer, should throw', function () {
            var writer = new writer_1.default();
            assert.throws(function () { return writer.writeVarInt(MIN_SAFE_INTEGER - 1); }, 'Int is smaller than safe JavaScript range');
        });
        it('when trying to write an eight-byte integer, should throw', function () {
            var writer = new writer_1.default();
    ...
    describe('writeUInt64', function () {
        ...
        it('when writing an unsafe integer, should throw', function () {
            var writer = new writer_1.default();
            assert.throws(function () { return writer.writeUInt64(MAX_SAFE_INTEGER + 1); }, 'Expected 64-bit integer as an array of two 32-bit words');
        });
    });
});
